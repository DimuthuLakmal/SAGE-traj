...
def main(cfg, auto_remove_exp_dir=False, debug=False, load_policy_checkpoint=False):
    ...
    cfg.algo.name = 'bits_spatial_planner'
    model = algo_factory(
        config=cfg,
...
if __name__ == "__main__":
    ...
    main(default_config, auto_remove_exp_dir=args.remove_exp_dir, debug=args.debug, load_policy_checkpoint=args.load_policy_checkpoint)