...
class SpatialPlannerConfig(BehaviorCloningConfig):
    def __init__(self):
        ...
        self.image_encoder_channels = (64, 128, 256, 512)
        self.bottleneck_blocks = 3
        self.bottleneck_temporal_kernel = 3

        self.num_eval_samples = 4
        # self.loss_weights = {
        #     "diffusion_loss": 1.0,
        # }
...
class DiffuserConfig(AlgoConfig):
    def __init__(self):
        ...
        self.lyft_norm_info = {
            "diffuser": [
                (-11.374039898241373, -0.021664260611354538, -4.355955099451367, -0.003182838616731075, -0.030428154804694928, -0.0015639846001038185),
                (57.167795884785306, 5.425857853474879, 18.096202637413143, 0.6244505157194253, 44.790435266404586, 2.963109160984688),
            ]
        }
