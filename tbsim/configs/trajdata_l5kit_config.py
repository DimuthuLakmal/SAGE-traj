...
class L5KitTrajdataTrainConfig(TrajdataTrainConfig):
    def __init__(self):
        ...
        self.trajdata_cache_location = "/data/gpfs/projects/punim2030/data/lyft/unified_data_cache"
        ...
        self.trajdata_data_dirs = {
            "lyft_train" : "/data/gpfs/projects/punim2030/data/lyft/scenes/train.zarr",
            "lyft_val" : "/data/gpfs/projects/punim2030/data/lyft/scenes/validate.zarr",
        }
        # for debug
        ...
        self.validation.every_n_steps = 5000
