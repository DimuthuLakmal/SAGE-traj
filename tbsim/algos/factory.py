...
def algo_factory(config: ExperimentConfig, modality_shapes: dict, data_cache_dir: str=None):
    """
    ...
    if algo_name == "bc":
        ...
        algo = MLLMSpatialPlanner(algo_config=algo_config, modality_shapes=modality_shapes)
    elif algo_name == "bits_spatial_planner":
        algo = SpatialPlanner(algo_config=algo_config, modality_shapes=modality_shapes)
    elif algo_name == "l5_spatial_planner":
        algo = SpatialPlanner(algo_config=algo_config, modality_shapes=modality_shapes)
        ...
        algo = DiffuserTrafficModel(algo_config=algo_config, modality_shapes=modality_shapes, registered_name=config.registered_name, data_cache_dir=data_cache_dir)
