...
def load_goal_predictor(
    ...
    """
    Loads either:
        1. a normal PyTorch checkpoint containing state_dict
        2. a PyTorch Lightning checkpoint containing "state_dict"
    """

    # ModelClass = import_from_string(model_class_path)
    ...
    if isinstance(ckpt, dict) and "state_dict" in ckpt:
        ...
        for k, v in state_dict.items():
            ...
            elif k.startswith("goal_predictor."):
                cleaned_state_dict[k[len("goal_predictor."):]] = v
            else:
