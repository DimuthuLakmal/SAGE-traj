...
class PerturbationGuidance(object):
    ...
    def perturb(self, x_initial, data_batch, opt_params, num_samp=1, decoder=None, return_grad_of=None, data_batch_perturb=None):
        '''
        ...
        for _ in range(opt_params['grad_steps']):
            with torch.enable_grad():
                ...
                tot_loss, per_losses = self.current_guidance.compute_guidance_loss(x_loss, data_batch_perturb)
