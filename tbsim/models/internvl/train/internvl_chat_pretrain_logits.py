...
from tbsim.models.internvl.train.distill_trainer import DistillSFTTrainer
...
class DataTrainingArguments:
    ...
    logits_path: str = field(
        default=None,
        metadata={'help': 'The path of the logits file of datasets.'},
    )
...
class LazySupervisedDataset(Dataset):
    ...
    def multi_modal_multi_image_get_item(self, data_item):
        ...
        for image_path in data_item['image']:
            idx = image_path.split("/")[-1].split(".")[0].split("_")[0]
            # Merge the image path
...
def main():
    ...
    trainer = DistillSFTTrainer(
        logits_path=data_args.logits_path,
        teacher_vocab_size=len(tokenizer),  #Teacher and students vocab size is similar
